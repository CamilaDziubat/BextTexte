...
const handleLogout = () => {
  // Aqui você pode adicionar a lógica de logout, como limpar tokens de autenticação
  ...
  <div class="relative" ref="target">
    ...
    >
      <span class="hidden text-right lg:block">
        <span class="block text-sm font-medium text-black dark:text-white">Camila Dziubat</span>
        <span class="block text-xs font-medium">Front-End Developer </span>
      </span>

<template>
  ...
  >
    ...
    <div class="px-4 pb-6 text-center lg:pb-8 xl:pb-11.5">
      ...
      <div class="mt-4">
        <h3 class="mb-1.5 text-2xl font-medium text-black dark:text-white">Camila Dziubat</h3>
        ...
        <div class="mt-6.5">
          <h4 class="mb-3.5 font-medium text-black dark:text-white">Esta sou Eu</h4>
